...
const FEATURES = [
  {
    ...
    desc: 'No drop-offs, no waiting rooms. We arrive fully equipped — water, power, and professional gear — so you keep your day.',
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "We don't leave until you're fully satisfied. If something isn't right, we make it right — no questions asked.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="container">
        ...
        <div className="whyus__header reveal">
          ...
          <h2 className="section-heading">
            Built Different.{' '}
            <span className="text-chrome">Driven by Detail.</span>
          </h2>
