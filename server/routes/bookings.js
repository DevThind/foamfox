...
const sendBookingEmails = async (booking) => {
    ...
    <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;background:#07070f;color:#fff;border-radius:16px;overflow:hidden;">
      ...
      <div style="padding:2rem;">
        ...
        <table style="width:100%;border-collapse:collapse;margin:1.5rem 0;">
          <tr><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;color:#8ab0cc;font-size:0.85rem;width:140px;">Service</td><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;">${booking.service}</td></tr>
          <tr><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;color:#8ab0cc;font-size:0.85rem;">Vehicle</td><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;">${booking.vehicleMakeModel} (${booking.vehicleType})</td></tr>
          <tr><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;color:#8ab0cc;font-size:0.85rem;">Date & Time</td><td style="padding:0.6rem 0.8rem;border-bottom:1px solid #1a2a40;">${booking.date} at ${booking.time}</td></tr>
          <tr><td style="padding:0.6rem 0.8rem;color:#8ab0cc;font-size:0.85rem;">Location</td><td style="padding:0.6rem 0.8rem;">${booking.address}, ${booking.city}</td></tr>
        </table>
  ...
  const adminHtml = `
    ...
    <p><strong>Vehicle:</strong> ${booking.vehicleMakeModel} (${booking.vehicleType})</p>
...
router.post('/', bookingLimiter, bookingValidation, async (req, res, next) => {
  try {
    ...
    /* Send emails in background — don't await so it doesn't slow response */
...
/* GET /api/bookings — admin list (protected by secret header) */
